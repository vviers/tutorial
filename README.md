# Tutoriel "Dev pour non-devs" de beta.gouv.fr

Ce tutoriel est une réadaptation du tutoriel "Django Girls". Nous proposons de développer une page d'accueil en utilisant le Design System de l'Etat.
